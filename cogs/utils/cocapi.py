...
class ApiCall(object):
    ...
    async def new_token(self):
        ...
        async with self.session.post(coc_api_login_url, json=login_data, headers=login_headers) as sess:
        ...
        async with self.session.post(list_tokens_url, data=json.dumps({}), headers=token_header) as sess:
